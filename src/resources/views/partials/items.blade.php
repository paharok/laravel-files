@foreach($files as $file)
    <div class="plf-file-item plf-file-item-{{ $file['type'] }}" data-path="{{ $file['minPath'] }}" data-url="{{ $file['url'] }}" data-publicPath="{{ $file['publicPath'] }}">
        ...
        <button class="plf-pop-rename" type="button" data-path="{{ $file['minPath'] }}"
                data-action="{{ route('laravel-files.rename') }}"
                @if($file['type'] == 'dir')
                    data-prompt="@lang('laravelfiles::plf.questRenameDir')"
                @else
                    data-prompt="@lang('laravelfiles::plf.questRenameFile')"
                @endif
